...
export const venueSchema = z.object({
  ...
  venueType: z.enum(
    ["Yoga Studio", "Wellness Center", "Retreat Space",],
    {
  ...
  bedConfiguration: z.string().min(5, {
