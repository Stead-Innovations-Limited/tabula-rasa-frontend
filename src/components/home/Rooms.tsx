      ...
      <div className='w-full bg-olive'>
        <div className='relative z-2 w-full py-5 px-5 xl:px-0 lg:py-14 xl:max-w-[1140px] mx-auto grid grid-cols-4 font-roboto '>
          ...
          <div className='flex flex-col justify-center items-center'>
            ...
            <p className='text-center text-white text-sm lg:text-xl'>Explore</p>
          </div>
          {/* Sessions icon */}
          <div className='flex flex-col justify-center items-center'>
            <div className='relative size-8 lg:size-12'>
          ...
          <div className='flex flex-col justify-center items-center'>
            ...
            <p className='text-center text-white text-sm lg:text-xl'>Venues</p>
          </div>
          {/* Events icon */}
          <div className='flex flex-col justify-center items-center'>
            <div className='relative size-8 lg:size-12'>
            ...
            <p className='text-center text-white text-sm lg:text-xl'>Events</p>
          </div>
        </div>
      </div>
    </section>
      ...
      <div className='relative z-2 w-fit p-5 bg-black/70 backdrop-opacity-80'>
        <div className='flex gap-2'>
          <Separator
            ...
            className='bg-white/80 !h-16 !w-1'
          />
